...
function animationsInit(e) {
console.log(e);
let t = new IntersectionObserver(function(e, t) {
e.forEach(function(e) {
	let i = $(e.target);
	let   n = i.attr("data-animate");
	let   s = i.attr("data-animate-out");
	let   a = i.attr("data-delay");
	let   r = i.attr("data-delay-out");
	let   o = 0;
	let   l = 3e3;
...
var divs = document.querySelectorAll("[data-animate]:not(.animated)");
